...
/**
 * Created by hoaipc on 1/6/16.
 */
public class TcpClientConfigThread
{
     ...
     */
    public TcpClientConfigThread(OnMessageReceived listener, String ip, int port, String request)
    {
        this.SERVERIP = ip;
